...
public class MockAiService {
    ...
    public String generateLuckyCardMessage(String prompt) {
        ...
        String[] cafeLuckyMessages = {
                "이 따뜻한 밀크티가 당신의 새로운 사랑을 달콤하게 만들어줄 거예요.",
                "이 상큼한 레몬에이드가 당신의 새로운 시작을 상쾌하게 도와줄 거예요.",
                "이 진한 아메리카노가 당신의 집중력과 결단력을 깨워줄 거예요.",
                "이 달콤한 카라멜 마키아토가 당신의 달콤한 미래를 예고해줄 거예요.",
                "이 부드러운 허브티가 당신의 마음에 평화와 안정을 가져다줄 거예요.",
                "이 시원한 아이스티가 당신의 열정을 시원하게 식혀줄 거예요.",
                "이 고소한 견과 라떼가 당신의 든든한 기반을 만들어줄 거예요.",
                "이 향긋한 얼그레이가 당신의 우아한 변화를 이끌어줄 거예요.",
                "이 달콤 쌉싸름한 모카가 당신의 복잡한 감정을 정리해줄 거예요.",
                "이 청량한 민트차가 당신의 새로운 에너지를 불어넣어줄 거예요."
        };

        Random random = new Random();
        return cafeLuckyMessages[random.nextInt(cafeLuckyMessages.length)];
    }
